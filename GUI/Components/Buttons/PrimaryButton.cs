...
namespace GUI.Components.Buttons {
    ...
    public class PrimaryButton : Button {
        ...
        public PrimaryButton(string label, Image? icon = null) {
            InitializeDefaults();
        ...
        private void InitializeDefaults() {
            ...
            // xanh thương hiệu
            NormalBackColor = Color.FromArgb(155, 209, 243);
            NormalForeColor = Color.White;
            NormalBorderColor = Color.FromArgb(40, 40, 40);

            HoverBackColor = Color.White;                 // khi hover → nền trắng
            HoverForeColor = Color.FromArgb(0, 92, 175);  // chữ xanh rõ
            HoverBorderColor = Color.FromArgb(0, 92, 175);  // viền xanh

            PressedBackColor = Color.FromArgb(225, 240, 255);
            PressedForeColor = Color.FromArgb(0, 92, 175);
            PressedBorderColor = Color.FromArgb(0, 92, 175);
